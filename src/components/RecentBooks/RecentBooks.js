    ...
    <div className="w3-container w3-content w3-padding-64" style={{"max-width":"800px"}}>
      ...
      <div className="w3-row-padding w3-padding-32" style={{margin:"0 -16px"}}>
        <div className="w3-quarter w3-margin-bottom">
          <img src="https://wallpaperaccess.com/full/6875194.jpg" alt="New York" style={{width:"100%"}} className="w3-hover-opacity" />
        ...
        <div className="w3-quarter w3-margin-bottom">
          <img src="https://wallpaperaccess.com/full/6875194.jpg" alt="Paris" style={{width:"100%"}} className="w3-hover-opacity" />
          <div className="w3-container w3-white">
            <p><b>Paris</b></p>
        ...
        <div className="w3-quarter w3-margin-bottom">
          <img src="https://wallpaperaccess.com/full/6875194.jpg" alt="San Francisco" style={{width:"100%"}} className="w3-hover-opacity" />
          <div className="w3-container w3-white">
        ...
        </div>    <div className="w3-quarter w3-margin-bottom">
          <img src="https://wallpaperaccess.com/full/6875194.jpg" alt="New York" style={{width:"100%"}} className="w3-hover-opacity" />
          <div className="w3-container w3-white">
            <p><b>New York</b></p>
            <p className="w3-opacity">Fri 27 Nov 2016</p>
